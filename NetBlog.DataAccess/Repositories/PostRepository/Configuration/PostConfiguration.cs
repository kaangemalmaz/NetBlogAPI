...
namespace NetBlog.DataAccess.Repositories.PostRepository.Configuration
{
    internal class PostConfiguration : IEntityTypeConfiguration<Post>
    {
        ...
        {
            builder.HasKey(a => a.Id); //tablonun keyi id
            builder.Property(a => a.Id).ValueGeneratedOnAdd(); // bu key değeri 1 1 otomatik artacak.
            ...
            //builder.Property(a => a.Content).IsRequired().HasColumnType("text"); //postgre için! varchar(max) denir.
            ...
            builder.HasOne(a => a.Category).WithMany(c => c.Posts).HasForeignKey(a => a.CategoryId);
