using AutoMapper;
using NetBlog.Business.Repositories.PostRepository.Constants;
using NetBlog.Business.Repositories.PostRepository.Validation.FluentValidation;
    ...
    public class PostManager : IPostService
    {
        ...
        public async Task<IResult> UpdateAsync(UpdatePostDto updatePostDto)
        {
            try
            {
                ...
                await _postDal.UpdateAsync(_mapper.Map(updatePostDto, oldPost));
