using AutoMapper;
using NetBlog.Business.Repositories.CategoryRepository.Constants;
...
namespace NetBlog.Business.Repositories.CategoryRepository
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IResult> UpdateAsync(UpdateCategoryDto updateCategoryDto)
        {
            try
            {
                ...
                await _categoryDal.UpdateAsync(_mapper.Map(updateCategoryDto, oldCategory));
